...
%%%%% Comparison of numerically estimated and analytically computed gradients for W and b %%%%
% no_points = 20;
% no_dim = 3027;
% 
% h = 1e-5;
...
% m = 50;
% % 
% [rel_err_gradb1, rel_err_gradb2, rel_err_gradW1, rel_err_gradW2] = computeRelativeErrorNumericalAnalyticalGradients(Xtr, Xva, Xte, Ytr, lambda, h, eps, m, no_points, no_dim );

% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% 
% %%% Test on page 6 : Make sure that this parametersetting strongly overfitts the data %%%%
...
% 
% [W_init, Xtr, Ytr, ytr, Xte, Yte, yte, Xva, Yva, yva] = reduceDimData(W_init, Xtr, Ytr, ytr, Xte, Yte, yte, Xva, Yva, yva, no_points, no_dim )
% 
...
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TEST ACCURACY %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% acc_test_fig4 = ComputeAccuracy(Xte, yte, Wstar, bstar);
...
% GDparameters.eta = 0;
% GDparameters.eta_vec = zeros(1005,1);
% GDparameters.n_s = 500;
% GDparameters.l = 0;
% GDparameters.update_step = 0;
% GDparameters.n_epochs = 10;
% 
% %Get the dimensions of the data
% [d, ~] = size(Xtr);
% K = max(ytr); 
...
% GDparameters.eta_max = 1e-1;
% GDparameters.eta = 0;
% GDparameters.n_s = 2*floor(n/GDparameters.n_batch);
% GDparameters.l = 0;
% GDparameters.update_step = 0;
% GDparameters.n_epochs = 8;
% 
% GDparameters.eta_vec = zeros(1005,1);
% 
% 
...
% [b_init, W_init] = initilizeWeightsAndBiases(K, d, m);
% 
% GridSearch(Xtr, Ytr, ytr, Xva, Yva, yva, no_runs, no_cycles,GDparameters, l_min, l_max, b_init, W_init, 'CoarseGridSearch.txt' );
...
%Forward pass
[P_batch, h_batch] = EvaluateClassifier(X, W, b); %  KxN  ,   mxN
